...
import { FaStar, FaRegStar, FaShippingFast, FaShieldAlt, FaBoxOpen, FaPlus, FaMinus, FaHeart, FaShareAlt } from 'react-icons/fa';
          ...
          <div className="flex space-x-4 overflow-x-auto pb-2">
            {images.map((image, index) => (
              <img
                ...
                className={`w-24 h-16 object-cover rounded-md cursor-pointer ${mainImage === image ? 'border-2 border-blue-500' : 'border-2 border-gray-300'
                  }`}
        ...
        <div className="w-full lg:w-1/2 p-8 lg:p-12">
          <div className="flex justify-between items-center mb-4">
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-800">Tony Gold Necklaces</h1>
            </div>
          ...
          <div className="flex items-center mb-6">
            ...
            <span className="text-description text-sm">(1 customer review)</span>
          </div>

          <div className="mb-6">
            <span className="text-description text-3xl font-bold mr-2">$260.00</span>
            <span className="text-description line-through text-lg">$360.00</span>
          </div>

          <p className="text-description leading-relaxed mb-6">
            Eget facilisis cum habitant egestas convallis turpis phasellus, ante parturient donec duis primis nam facilisi eu augue malesuada venenatis
          </p>
          ...
          <div className="mb-6">
            <p className="text-description mb-2">Only 15 items left in stock!</p>
            <div className="w-full bg-gray-200 rounded-full h-2.5">
              <div className="bg-description h-2.5 rounded-full" style={{ width: '30%' }}></div>
            </div>
          </div>
          ...
          <ul className="mb-8 space-y-3">
            ...
            <li className="flex items-center text-description">
              <FaShippingFast className="text-description mr-3" /> Free shipping via DHL, fully insured
            </li>
            <li className="flex items-center text-description">
              <FaShieldAlt className="text-description mr-3" /> All taxes and customs duties included
            </li>
          </ul>

          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-8">
            <div className="flex items-center border border-gray-300 rounded-md">
              <Link href='' className="p-3 border-r border-gray-300 text-gray-600 hover:bg-gray-100">
                <FaMinus />
              </Link>
              <span className="p-3 text-lg font-semibold text-gray-800">1</span>
              <button className="p-3 border-l border-gray-300 text-gray-600 hover:bg-gray-100">
                <FaPlus />
              </button>
            </div>
            <Link href='#' className="flex-1  text-description py-3 px-6 rounded-md border-description border  transition duration-300 flex items-center justify-center">
